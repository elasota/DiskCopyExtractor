...
typedef struct {
  ...
  // ejl - Add HFS timestamps
  time_t crdatehfs;		/* date of creation in HFS epoch */
  time_t mddatehfs;		/* date of last modification in HFS epoch */
  time_t bkdatehfs;		/* date of last backup in HFS epoch */
