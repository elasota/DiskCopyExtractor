		    ...
		    const CatDataRec *data, hfsdirent *ent)
{
  ...
  switch (data->cdrType)
    ...
    case cdrDirRec:
      ...
      // ejl - Preserve HFS timestamps
      ent->crdatehfs = data->u.dir.dirCrDat;
      ent->mddatehfs = data->u.dir.dirMdDat;
      ent->bkdatehfs = data->u.dir.dirBkDat;
    ...
    case cdrFilRec:
      ...
      // ejl - Preserve HFS timestamps
      ent->crdatehfs = data->u.fil.filCrDat;
      ent->mddatehfs = data->u.fil.filMdDat;
      ent->bkdatehfs = data->u.fil.filBkDat;
